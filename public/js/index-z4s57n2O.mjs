import { n as fe, s as Ke, T as E, o as Y, R as Hr, a as g, t as L, p as H, y as ae } from "./index-BpwYrnZo.mjs";
import { b as M, c as Br } from "./main-4adyJypS.mjs";
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Qe = window, Bt = Qe.ShadowRoot && (Qe.ShadyCSS === void 0 || Qe.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Zt = Symbol(), qt = /* @__PURE__ */ new WeakMap();
let $r = class {
  constructor(e, r, i) {
...
const Zr = (t) => new $r(typeof t == "string" ? t : t + "", void 0, Zt), C = (t, ...e) => {
  ...
  Bt ? t.adoptedStyleSheets = e.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet) : e.forEach((r) => {
 ...
 */
var ot;
const Ge = window, Qt = Ge.trustedTypes, Vr = Qt ? Qt.emptyScript : "", Yt = Ge.reactiveElementPolyfillSupport, Lt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Vr : null;
      break;
  ...
  return r;
} }, Cr = (t, e) => e !== t && (e == e || t == t), it = { attribute: !0, type: String, converter: Lt, reflect: !1, hasChanged: Cr }, Wt = "finalized";
let ue = class extends HTMLElement {
  ...
  _$EO(e, r, i = it) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const a = (((o = i.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== void 0 ? i.converter : Lt).toAttribute(r, i.type);
  ...
  _$AK(e, r) {
    ...
    if (n !== void 0 && this._$El !== n) {
      const a = o.getPropertyOptions(n), s = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((i = a.converter) === null || i === void 0 ? void 0 : i.fromAttribute) !== void 0 ? a.converter : Lt;
      this._$El = n, this[n] = s.fromAttribute(r, a.type), this._$El = null;
    }
  }
  requestUpdate(e, r, i) {
    let o = !0;
    e !== void 0 && (((i = i || this.constructor.getPropertyOptions(e)).hasChanged || Cr)(this[e], r) ? (this._$AL.has(e) || this._$AL.set(e, r), i.reflect === !0 && this._$El !== e && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(e, i))) : o = !1), !this.isUpdatePending && o && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
ue[Wt] = !0, ue.elementProperties = /* @__PURE__ */ new Map(), ue.elementStyles = [], ue.shadowRootOptions = { mode: "open" }, Yt == null || Yt({ ReactiveElement: ue }), ((ot = Ge.reactiveElementVersions) !== null && ot !== void 0 ? ot : Ge.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var nt;
const Xe = window, be = Xe.trustedTypes, Gt = be ? be.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Dt = "$lit$", Q = `lit$${(Math.random() + "").slice(9)}$`, Ar = "?" + Q, Fr = `<${Ar}>`, se = document, Se = () => se.createComment(""), Re = (t) => t === null || typeof t != "object" && typeof t != "function", _r = Array.isArray, qr = (t) => _r(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", at = `[ 	
\f\r]`, Ce = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xt = /-->/g, Jt = />/g, ee = RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), er = /'/g, tr = /"/g, Er = /^(?:script|style|textarea|title)$/i, Or = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), l = Or(1), Ye = Or(2), le = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), rr = /* @__PURE__ */ new WeakMap(), ie = se.createTreeWalker(se, 129, null, !1);
function kr(t, e) {
...
const Kr = (t, e) => {
  ...
  for (let s = 0; s < r; s++) {
    ...
    for (; m < c.length && (a.lastIndex = m, x = a.exec(c), x !== null); )
      m = a.lastIndex, a === Ce ? x[1] === "!--" ? a = Xt : x[1] !== void 0 ? a = Jt : x[2] !== void 0 ? (Er.test(x[2]) && (o = RegExp("</" + x[2], "g")), a = ee) : x[3] !== void 0 && (a = ee) : a === ee ? x[0] === ">" ? (a = o ?? Ce, $ = -1) : x[1] === void 0 ? $ = -2 : ($ = a.lastIndex - x[2].length, d = x[1], a = x[3] === void 0 ? ee : x[3] === '"' ? tr : er) : a === tr || a === er ? a = ee : a === Xt || a === Jt ? a = Ce : (a = ee, o = void 0);
    const _ = a === ee && t[s + 1].startsWith("/>") ? " " : "";
    n += a === Ce ? c + Fr : $ >= 0 ? (i.push(d), c.slice(0, $) + Dt + c.slice($) + Q + _) : c + Q + ($ === -2 ? (i.push(void 0), s) : _);
  }
  return [kr(t, n + (t[r] || "<?>") + (e === 2 ? "</svg>" : "")), i];
};
class Le {
  constructor({ strings: e, _$litType$: r }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const s = e.length - 1, c = this.parts, [d, x] = Kr(e, r);
      ...
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          ...
          for (const m of o.getAttributeNames())
            if (m.endsWith(Dt) || m.startsWith(Q)) {
              const _ = x[a++];
              if ($.push(m), _ !== void 0) {
                const f = o.getAttribute(_.toLowerCase() + Dt).split(Q), u = /([.?@])?(.*)/.exec(_);
                c.push({ type: 1, index: n, name: u[2], strings: f, ctor: u[1] === "." ? Yr : u[1] === "?" ? Xr : u[1] === "@" ? Jr : rt });
              } else
...
class Qr {
  ...
  u(e) {
    ...
    for (; d !== void 0; ) {
      if (s === d.index) {
        let x;
        d.type === 2 ? x = new De(a, a.nextSibling, this, e) : d.type === 1 ? x = new d.ctor(a, d.name, d.strings, this, e) : d.type === 6 && (x = new eo(a, this, e)), this._$AV.push(x), d = o[++c];
      }
...
class De {
  constructor(e, r, i, o) {
    var n;
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = e, this._$AB = r, this._$AM = i, this.options = o, this._$Cp = (n = o == null ? void 0 : o.isConnected) === null || n === void 0 || n;
  }
  get _$AU() {
    var e, r;
  ...
  _$AI(e, r = this) {
    e = ye(this, e, r), Re(e) ? e === T || e == null || e === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : e !== this._$AH && e !== le && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : qr(e) ? this.T(e) : this._(e);
  }
  k(e) {
  ...
  _(e) {
    this._$AH !== T && Re(this._$AH) ? this._$AA.nextSibling.data = e : this.$(se.createTextNode(e)), this._$AH = e;
  }
  g(e) {
    var r;
    const { values: i, _$litType$: o } = e, n = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = Le.createElement(kr(o.h, o.h[0]), this.options)), o);
  ...
  _$AC(e) {
    ...
    return r === void 0 && rr.set(e.strings, r = new Le(e)), r;
  }
  T(e) {
...
class rt {
  constructor(e, r, i, o, n) {
    this.type = 1, this._$AH = T, this._$AN = void 0, this.element = e, this.name = r, this._$AM = o, this.options = n, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = T;
  }
  get tagName() {
  ...
  _$AI(e, r = this, i, o) {
    ...
    if (n === void 0)
      ...
      for (e = n[0], c = 0; c < n.length - 1; c++)
        d = ye(this, s[i + c], r, c), d === le && (d = this._$AH[c]), a || (a = !Re(d) || d !== this._$AH[c]), d === T ? e = T : e !== T && (e += (d ?? "") + n[c + 1]), this._$AH[c] = d;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
const Gr = be ? be.emptyScript : "";
let Xr = class extends rt {
  constructor() {
...
class Jr extends rt {
  ...
  _$AI(e, r = this) {
    var i;
    if ((e = (i = ye(this, e, r, 0)) !== null && i !== void 0 ? i : T) === le)
      return;
    const o = this._$AH, n = e === T && o !== T || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, a = e !== T && (o === T || n);
...
const or = Xe.litHtmlPolyfillSupport;
or == null || or(Le, De), ((nt = Xe.litHtmlVersions) !== null && nt !== void 0 ? nt : Xe.litHtmlVersions = []).push("2.8.0");
const to = (t, e, r) => {
  var i, o;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ro = (t, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(r) {
...
function p(t) {
  return (e, r) => r !== void 0 ? oo(t, e, r) : ro(t, e);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const io = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, no = (t) => (...e) => ({ _$litDirective$: t, values: e });
class ao {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = no(class extends ao {
  constructor(t) {
    var e;
    if (super(t), t.type !== io.ATTRIBUTE || t.name !== "class" || ((e = t.strings) === null || e === void 0 ? void 0 : e.length) > 2)
...
const Ir = (t, e, r) => Math.min(Math.max(r, t), e), j = {
  duration: 0.3,
  delay: 0,
  endDelay: 0,
  repeat: 0,
  easing: "ease"
}, Je = (t) => typeof t == "number", we = (t) => Array.isArray(t) && !Je(t[0]), lo = (t, e, r) => {
  const i = e - t;
  return ((r - t) % i + i) % i + t;
};
function co(t, e) {
  return we(t) ? t[lo(0, t.length, e)] : t;
}
const Tr = (t, e, r) => -r * t + r * e + t, Pr = () => {
...
function mo(t, e = ho(t.length), r = G) {
  const i = t.length, o = i - e.length;
  return o > 0 && Mr(e, o), (n) => {
    let a = 0;
    for (; a < i - 2 && !(n < e[a + 1]); a++)
      ;
    let s = Ir(0, 1, zt(e[a], e[a + 1], n));
    return s = co(r, a)(s), Tr(t[a], t[a + 1], s);
  };
}
const Sr = (t) => Array.isArray(t) && Je(t[0]), jt = (t) => typeof t == "object" && !!t.createAnimation, xe = (t) => typeof t == "function", po = (t) => typeof t == "string", Me = {
  ms: (t) => t * 1e3,
  s: (t) => t / 1e3
}, Rr = (t, e, r) => (((1 - 3 * r + 3 * e) * t + (3 * r - 6 * e)) * t + 3 * e) * t, uo = 1e-7, go = 12;
function wo(t, e, r, i, o) {
  let n, a, s = 0;
  do
    a = e + (r - e) / 2, n = Rr(a, i, o) - t, n > 0 ? r = a : e = a;
  while (Math.abs(n) > uo && ++s < go);
  return a;
}
function Pe(t, e, r, i) {
  if (t === e && r === i)
    return G;
  const o = (n) => wo(n, 0, 1, t, r);
  return (n) => n === 0 || n === 1 ? n : Rr(o(n), e, i);
}
const vo = (t, e = "end") => (r) => {
...
function ar(t) {
  ...
  if (t.startsWith("steps")) {
    ...
    if (e) {
      const r = e[1].split(",");
      return vo(parseFloat(r[0]), r[1].trim());
    }
  }
  return G;
}
class Lr {
  constructor(e, r = [0, 1], { easing: i, duration: o = j.duration, delay: n = j.delay, endDelay: a = j.endDelay, repeat: s = j.repeat, offset: c, direction: d = "normal", autoplay: x = !0 } = {}) {
    ...
    this.repeat = s, this.easing = we(i) ? G : ar(i), this.updateDuration(o);
    const $ = mo(r, c, we(i) ? i.map(ar) : G);
    this.tick = (m) => {
      var _;
      n = n;
      let f = 0;
      ...
      let k = Math.floor(u), b = u % 1;
      !b && u >= 1 && (b = 1), b === 1 && k--;
      const P = k % 2;
      (d === "reverse" || d === "alternate" && P || d === "alternate-reverse" && !P) && (b = 1 - b);
...
process.env.NODE_ENV !== "production" && (Nt = function(t, e) {
  if (!t)
    throw new Error(e);
});
class bo {
...
const xo = ["", "X", "Y", "Z"], $o = ["translate", "scale", "rotate", "skew"], et = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, sr = {
...
$o.forEach((t) => {
  xo.forEach((e) => {
    tt.push(t + e), We.set(Vt(t + e), Co[t]);
  });
});
const Ao = (t, e) => tt.indexOf(t) - tt.indexOf(e), _o = new Set(tt), Dr = (t) => _o.has(t), Eo = (t, e) => {
  et[e] && (e = et[e]);
  const { transforms: r } = Wr(t);
  so(r, e), t.style.transform = Oo(r);
}, Oo = (t) => t.sort(Ao).reduce(ko, "").trim(), ko = (t, e) => `${t} ${e}(var(${Vt(e)}))`, Ut = (t) => t.startsWith("--"), lr = /* @__PURE__ */ new Set();
function Io(t) {
  if (!lr.has(t)) {
    lr.add(t);
    try {
...
const ht = (t, e) => document.createElement("div").animate(t, e), cr = {
...
for (const t in cr)
  ge[t] = () => (mt[t] === void 0 && (mt[t] = cr[t]()), mt[t]);
const To = 0.015, Po = (t, e) => {
  let r = "";
  const i = Math.round(e / To);
  for (let o = 0; o < i; o++)
    r += t(zt(0, i - 1, o)) + ", ";
  return r.substring(0, r.length - 2);
}, dr = (t, e) => xe(t) ? ge.linearEasing() ? `linear(${Po(t, e)})` : j.easing : Sr(t) ? Mo(t) : t, Mo = ([t, e, r, i]) => `cubic-bezier(${t}, ${e}, ${r}, ${i})`;
function So(t, e) {
...
function Ht(t) {
  return et[t] && (t = et[t]), Dr(t) ? Vt(t) : t;
}
const Ue = {
  get: (t, e) => {
    e = Ht(e);
    let r = Ut(e) ? t.style.getPropertyValue(e) : getComputedStyle(t)[e];
    if (!r && r !== 0) {
      const i = We.get(e);
      i && (r = i.initialValue);
    }
  ...
  set: (t, e, r) => {
    e = Ht(e), Ut(e) ? t.style.setProperty(e, r) : t.style[e] = r;
  }
};
function jr(t, e = !0) {
...
function Do(t, e, r, i = {}, o) {
  const n = Wo(), a = i.record !== !1 && n;
  let s, { duration: c = j.duration, delay: d = j.delay, endDelay: x = j.endDelay, repeat: $ = j.repeat, easing: m = j.easing, persist: _ = !1, direction: f, offset: u, allowWebkitAcceleration: k = !1, autoplay: b = !0 } = i;
  const P = Wr(t), S = Dr(e);
  let D = ge.waapi();
  S && Eo(t, e);
  const N = Ht(e), je = yo(P.values, N), z = We.get(N);
  return jr(je.animation, !(jt(m) && je.generator) && i.record !== !1), () => {
    const Ne = () => {
      var O, $e;
      return ($e = (O = Ue.get(t, N)) !== null && O !== void 0 ? O : z == null ? void 0 : z.initialValue) !== null && $e !== void 0 ? $e : 0;
    };
    let I = So(Ro(r), Ne);
    const Ft = Lo(I, z);
    if (jt(m)) {
      const O = m.createAnimation(I, e !== "opacity", Ne, N, je);
      m = O.easing, I = O.keyframes || I, c = O.duration || c;
    }
    if (Ut(N) && (ge.cssRegisterProperty() ? Io(N) : D = !1), S && !ge.linearEasing() && (xe(m) || we(m) && m.some(xe)) && (D = !1), D) {
      z && (I = I.map((J) => Je(J) ? z.toDefaultUnit(J) : J)), I.length === 1 && (!ge.partialKeyframes() || a) && I.unshift(Ne());
      const O = {
        delay: Me.ms(d),
        duration: Me.ms(c),
        endDelay: Me.ms(x),
        easing: we(m) ? void 0 : dr(m, c),
        direction: f,
        iterations: $ + 1,
        fill: "both"
      };
      s = t.animate({
        [N]: I,
        offset: u,
        easing: we(m) ? m.map((J) => dr(J, c)) : void 0
      }, O), s.finished || (s.finished = new Promise((J, Ur) => {
        s.onfinish = J, s.oncancel = Ur;
      }));
      const $e = I[I.length - 1];
      s.finished.then(() => {
        _ || (Ue.set(t, N, $e), s.cancel());
      }).catch(Pr), k || (s.playbackRate = 1.000001);
    } else if (o && S)
      I = I.map((O) => typeof O == "string" ? parseFloat(O) : O), I.length === 1 && I.unshift(parseFloat(Ne())), s = new o((O) => {
        Ue.set(t, N, Ft ? Ft(O) : O);
      ...
      Ue.set(t, N, z && Je(O) ? z.toDefaultUnit(O) : O);
    }
    return a && n(t, e, I, {
      duration: c,
      delay: d,
...
const Uo = (t) => t(), Nr = (t, e, r = j.duration) => new Proxy({
  animations: t.map(Uo).filter(Boolean),
  duration: r,
  options: e
  ...
  get: (t, e) => {
    ...
    switch (e) {
      ...
      case "finished":
        return t.finished || (t.finished = Promise.all(t.animations.map(Zo)).catch(Pr)), t.finished;
      case "stop":
        return () => {
          t.animations.forEach((i) => jr(i));
        };
      case "forEachNative":
        return (i) => {
...
function Vo(t) {
  return function(r, i, o = {}) {
    r = No(r);
    const n = r.length;
    Nt(!!n, "No valid element provided."), Nt(!!i, "No keyframes defined.");
    const a = [];
    for (let s = 0; s < n; s++) {
      const c = r[s];
      for (const d in i) {
 ...
 */
const R = (t) => t ?? T;
var Ko = Object.defineProperty, hr = Object.getOwnPropertySymbols, Qo = Object.prototype.hasOwnProperty, Yo = Object.prototype.propertyIsEnumerable, mr = (t, e, r) => e in t ? Ko(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, pt = (t, e) => {
  for (var r in e || (e = {}))
    Qo.call(e, r) && mr(t, r, e[r]);
  if (hr)
    for (var r of hr(e))
      Yo.call(e, r) && mr(t, r, e[r]);
  return t;
};
function Go() {
  var t;
...
V.styles = [v.globalCss, Xo], ce([p({ type: Boolean })], V.prototype, "disabled", 2), ce([p()], V.prototype, "iconLeft", 2), ce([p()], V.prototype, "iconRight", 2), ce([p()], V.prototype, "onClick", 2), ce([p()], V.prototype, "variant", 2), V = ce([y("wcm-button")], V);
const ti = C`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
var ri = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, ut = (t, e, r, i) => {
...
Ae.styles = [v.globalCss, ti], ut([p({ type: Boolean })], Ae.prototype, "disabled", 2), ut([p()], Ae.prototype, "variant", 2), Ae = ut([y("wcm-button-big")], Ae);
const ii = C`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var ni = Object.defineProperty, ai = Object.getOwnPropertyDescriptor, si = (t, e, r, i) => {
...
wt.styles = [v.globalCss, li], wt = hi([y("wcm-modal-backcard")], wt);
const mi = C`main{padding:20px;padding-top:0;width:100%}`;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, gi = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? ui(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
vt.styles = [v.globalCss, mi], vt = gi([y("wcm-modal-content")], vt);
const wi = C`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var vi = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, bi = (t, e, r, i) => {
...
ft.styles = [v.globalCss, wi], ft = bi([y("wcm-modal-footer")], ft);
const yi = C`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var xi = Object.defineProperty, $i = Object.getOwnPropertyDescriptor, _e = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? $i(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
let te = class extends w {
  ...
  render() {
    const t = { "wcm-border": this.border }, e = E.state.history.length > 1, r = this.title ? l`<wcm-text variant="big-bold">${this.title}</wcm-text>` : l`<slot></slot>`;
    return l`<header class="${Z(t)}">${e ? this.backBtnTemplate() : null} ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
te.styles = [v.globalCss, yi], _e([p()], te.prototype, "title", 2), _e([p()], te.prototype, "onAction", 2), _e([p()], te.prototype, "actionIcon", 2), _e([p({ type: Boolean })], te.prototype, "border", 2), te = _e([y("wcm-modal-header")], te);
const h = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(t, e) {
  ...
  e ? o ? E.push("MobileConnecting") : i ? E.push("WebConnecting") : E.push("InstallWallet") : r ? E.push("DesktopConnecting") : i ? E.push("WebConnecting") : o ? E.push("MobileQrcodeConnecting") : E.push("InstallWallet");
} }, Ci = C`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var Ai = Object.defineProperty, _i = Object.getOwnPropertyDescriptor, bt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? _i(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Ai(e, r, o), o;
};
...
Ee.styles = [v.globalCss, Ci], bt([W()], Ee.prototype, "view", 2), bt([W()], Ee.prototype, "prevView", 2), Ee = bt([y("wcm-modal-router")], Ee);
const Ei = C`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var Oi = Object.defineProperty, ki = Object.getOwnPropertyDescriptor, ur = (t, e, r, i) => {
...
He.styles = [v.globalCss, Ei], ur([W()], He.prototype, "open", 2), He = ur([y("wcm-modal-toast")], He);
const Ii = 0.1, gr = 2.5, B = 7;
function yt(t, e, r) {
  return t === e ? !1 : (t - e < 0 ? e - t : t - e) <= r + Ii;
}
function Ti(t, e) {
  const r = Array.prototype.slice.call(Br.create(t, { errorCorrectionLevel: e }).modules.data, 0), i = Math.sqrt(r.length);
  return r.reduce((o, n, a) => (a % i === 0 ? o.push([n]) : o[o.length - 1].push(n)) && o, []);
}
const Pi = { generate(t, e, r) {
  const i = "#141414", o = "#ffffff", n = [], a = Ti(t, "Q"), s = e / a.length, c = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  c.forEach(({ x: f, y: u }) => {
    const k = (a.length - B) * s * f, b = (a.length - B) * s * u, P = 0.45;
    for (let S = 0; S < c.length; S += 1) {
      const D = s * (B - S * 2);
      n.push(Ye`<rect fill="${S % 2 === 0 ? i : o}" height="${D}" rx="${D * P}" ry="${D * P}" width="${D}" x="${k + s * S}" y="${b + s * S}">`);
    }
  });
  ...
  return m.forEach(([f, u]) => {
    ...
    const k = u.filter((b) => u.every((P) => !yt(b, P, s)));
    return [Number(f), k];
  }).forEach(([f, u]) => {
    u.forEach((k) => {
      n.push(Ye`<circle cx="${f}" cy="${k}" fill="${i}" r="${s / gr}">`);
    });
  }), Object.entries(_).filter(([f, u]) => u.length > 1).map(([f, u]) => {
    const k = u.filter((b) => u.some((P) => yt(b, P, s)));
    return [Number(f), k];
  }).map(([f, u]) => {
    u.sort((b, P) => b < P ? -1 : 1);
    const k = [];
    for (const b of u) {
      const P = k.find((S) => S.some((D) => yt(b, D, s)));
      P ? P.push(b) : k.push([b]);
    }
    return [f, k.map((b) => [b[0], b[b.length - 1]])];
  }).forEach(([f, u]) => {
    u.forEach(([k, b]) => {
      n.push(Ye`<line x1="${f}" x2="${f}" y1="${k}" y2="${b}" stroke="${i}" stroke-width="${s / (gr / 2)}" stroke-linecap="round">`);
    });
  }), n;
} }, Mi = C`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}`;
var Si = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, de = (t, e, r, i) => {
...
let F = class extends w {
  ...
  svgTemplate() {
    ...
    return Ye`<svg height="${t}" width="${t}">${Pi.generate(this.uri, t, t / 4)}</svg>`;
  }
  render() {
...
F.styles = [v.globalCss, Mi], de([p()], F.prototype, "uri", 2), de([p({ type: Number })], F.prototype, "size", 2), de([p()], F.prototype, "imageId", 2), de([p()], F.prototype, "walletId", 2), de([p()], F.prototype, "imageUrl", 2), F = de([y("wcm-qrcode")], F);
const Li = C`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
var Wi = Object.defineProperty, Di = Object.getOwnPropertyDescriptor, wr = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Di(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
Be.styles = [v.globalCss, Li], wr([p()], Be.prototype, "onChange", 2), Be = wr([y("wcm-search-input")], Be);
const ji = C`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Ni = Object.defineProperty, Ui = Object.getOwnPropertyDescriptor, Hi = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Ui(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Ni(e, r, o), o;
};
...
Oe.styles = [v.globalCss, Bi], $t([p()], Oe.prototype, "variant", 2), $t([p()], Oe.prototype, "color", 2), Oe = $t([y("wcm-text")], Oe);
const Vi = C`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
var Fi = Object.defineProperty, qi = Object.getOwnPropertyDescriptor, q = (t, e, r, i) => {
...
let U = class extends w {
  ...
  handleClick() {
    Hr.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var t;
...
U.styles = [v.globalCss, Vi], q([p()], U.prototype, "onClick", 2), q([p()], U.prototype, "name", 2), q([p()], U.prototype, "walletId", 2), q([p()], U.prototype, "label", 2), q([p()], U.prototype, "imageId", 2), q([p({ type: Boolean })], U.prototype, "installed", 2), q([p({ type: Boolean })], U.prototype, "recent", 2), U = q([y("wcm-wallet-button")], U);
const Ki = C`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Qi = Object.defineProperty, Yi = Object.getOwnPropertyDescriptor, Ze = (t, e, r, i) => {
...
he.styles = [v.globalCss, Ki], Ze([p()], he.prototype, "walletId", 2), Ze([p()], he.prototype, "imageId", 2), Ze([p()], he.prototype, "imageUrl", 2), he = Ze([y("wcm-wallet-image")], he);
var Gi = Object.defineProperty, Xi = Object.getOwnPropertyDescriptor, vr = (t, e, r, i) => {
...
vr([W()], Ct.prototype, "preload", 2), Ct = vr([y("wcm-explorer-context")], Ct);
var Ji = Object.defineProperty, en = Object.getOwnPropertyDescriptor, tn = (t, e, r, i) => {
...
At.styles = [v.globalCss, rn], At = an([y("wcm-android-wallet-selection")], At);
const sn = C`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
var ln = Object.defineProperty, cn = Object.getOwnPropertyDescriptor, me = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? cn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && ln(e, r, o), o;
};
...
K.styles = [v.globalCss, sn], me([p()], K.prototype, "walletId", 2), me([p()], K.prototype, "imageId", 2), me([p({ type: Boolean })], K.prototype, "isError", 2), me([p({ type: Boolean })], K.prototype, "isStale", 2), me([p()], K.prototype, "label", 2), K = me([y("wcm-connector-waiting")], K);
...
} }, dn = C`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
var hn = Object.defineProperty, mn = Object.getOwnPropertyDescriptor, pn = (t, e, r, i) => {
...
_t.styles = [v.globalCss, dn], _t = pn([y("wcm-desktop-wallet-selection")], _t);
const un = C`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var gn = Object.defineProperty, wn = Object.getOwnPropertyDescriptor, vn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? wn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
Et.styles = [v.globalCss, un], Et = vn([y("wcm-legal-notice")], Et);
const fn = C`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var bn = Object.defineProperty, yn = Object.getOwnPropertyDescriptor, xn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? yn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
Ot.styles = [v.globalCss, fn], Ot = xn([y("wcm-mobile-wallet-selection")], Ot);
const $n = C`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var Cn = Object.defineProperty, An = Object.getOwnPropertyDescriptor, kt = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? An(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
ke.styles = [v.globalCss, $n], kt([W()], ke.prototype, "open", 2), kt([W()], ke.prototype, "active", 2), ke = kt([y("wcm-modal")], ke);
const _n = C`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var En = Object.defineProperty, On = Object.getOwnPropertyDescriptor, Ie = (t, e, r, i) => {
...
re.styles = [v.globalCss, _n], Ie([p({ type: Boolean })], re.prototype, "isMobile", 2), Ie([p({ type: Boolean })], re.prototype, "isDesktop", 2), Ie([p({ type: Boolean })], re.prototype, "isWeb", 2), Ie([p({ type: Boolean })], re.prototype, "isRetry", 2), re = Ie([y("wcm-platform-selection")], re);
const kn = C`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var In = Object.defineProperty, Tn = Object.getOwnPropertyDescriptor, Pn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Tn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && In(e, r, o), o;
};
...
It.styles = [v.globalCss, kn], It = Pn([y("wcm-view-all-wallets-button")], It);
const Mn = C`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var Sn = Object.defineProperty, Rn = Object.getOwnPropertyDescriptor, ze = (t, e, r, i) => {
...
pe.styles = [v.globalCss, Mn], ze([p()], pe.prototype, "walletId", 2), ze([p()], pe.prototype, "imageId", 2), ze([W()], pe.prototype, "uri", 2), pe = ze([y("wcm-walletconnect-qr")], pe);
var Ln = Object.defineProperty, Wn = Object.getOwnPropertyDescriptor, Dn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Wn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Ln(e, r, o), o;
};
...
Tt.styles = [v.globalCss], Tt = Dn([y("wcm-connect-wallet-view")], Tt);
const jn = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Nn = Object.defineProperty, Un = Object.getOwnPropertyDescriptor, br = (t, e, r, i) => {
...
Ve.styles = [v.globalCss, jn], br([W()], Ve.prototype, "isError", 2), Ve = br([y("wcm-desktop-connecting-view")], Ve);
const Hn = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Bn = Object.defineProperty, Zn = Object.getOwnPropertyDescriptor, zn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Zn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && Bn(e, r, o), o;
};
...
Pt.styles = [v.globalCss, Hn], Pt = zn([y("wcm-install-wallet-view")], Pt);
const Vn = C`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var Fn = Object.defineProperty, qn = Object.getOwnPropertyDescriptor, yr = (t, e, r, i) => {
...
Fe.styles = [v.globalCss, Vn], yr([W()], Fe.prototype, "isError", 2), Fe = yr([y("wcm-mobile-connecting-view")], Fe);
...
var Qn = Object.defineProperty, Yn = Object.getOwnPropertyDescriptor, Gn = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? Yn(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
...
Mt.styles = [v.globalCss, Kn], Mt = Gn([y("wcm-mobile-qr-connecting-view")], Mt);
var Xn = Object.defineProperty, Jn = Object.getOwnPropertyDescriptor, ea = (t, e, r, i) => {
...
St.styles = [v.globalCss], St = ea([y("wcm-qrcode-view")], St);
const ta = C`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var ra = Object.defineProperty, oa = Object.getOwnPropertyDescriptor, Te = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? oa(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && ra(e, r, o), o;
};
const Rt = 40;
let oe = class extends w {
  constructor() {
  ...
  isLastPage() {
    ...
    return i <= Rt || r.length >= i;
  }
  async fetchWallets() {
    var t;
    const { wallets: e, search: r } = L.state, { listings: i, total: o, page: n } = this.search ? r : e;
    if (!this.endReached && (this.firstFetch || o > Rt && i.length < o))
      try {
        this.loading = !0;
        const a = (t = H.state.chains) == null ? void 0 : t.join(","), { listings: s } = await L.getWallets({ page: this.firstFetch ? 1 : n + 1, entries: Rt, search: this.search, version: 2, chains: a }), c = s.map((d) => h.getWalletIcon(d));
...
oe.styles = [v.globalCss, ta], Te([W()], oe.prototype, "loading", 2), Te([W()], oe.prototype, "firstFetch", 2), Te([W()], oe.prototype, "search", 2), Te([W()], oe.prototype, "endReached", 2), oe = Te([y("wcm-wallet-explorer-view")], oe);
const ia = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var na = Object.defineProperty, aa = Object.getOwnPropertyDescriptor, xr = (t, e, r, i) => {
  for (var o = i > 1 ? void 0 : i ? aa(e, r) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, r, o) : a(o)) || o);
  return i && o && na(e, r, o), o;
};
...
qe.styles = [v.globalCss, ia], xr([W()], qe.prototype, "isError", 2), qe = xr([y("wcm-web-connecting-view")], qe);
export {
  ke as WcmModal,
  F as WcmQrCode
};
